...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="Pelanggan_produkJual.php" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li>
              <a class="dropdown-item" href="Pelanggan_produkJual.php">
                <i class="bi bi-grid"></i> Daftar Produk
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="Pelanggan_keranjangBelanja.php">
                <i class="bi bi-basket-fill"></i> Keranjang Belanja
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="Pelanggan_transaksiBelanja.php">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="Pelanggan_detailAkun.php">
