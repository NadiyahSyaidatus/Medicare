        ...
        <div class="col-lg-10">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-7">
                    ...
                    <div class="mt-4">
                        <a href="Pelanggan_produkJual.php" class="btn btn-secondary px-4">Kembali</a>
                        <?php if($produk["stokProduk"] == 0): ?>
                            <button class="btn btn-danger px-4" disabled>Stok Habis</button>
                        <?php else: ?>
                            <a href="Pelanggan_tambahKeranjang.php?idProduk=<?= $produk["idProduk"]; ?>" class="btn btn-danger px-4">Beli</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
