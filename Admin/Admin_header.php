...
<li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
              <a class="dropdown-item" href="Admin_allProduk.php">
                <i class="bi bi-basket-fill"></i> Daftar Produk
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="Admin_lihatTransaksi.php">
                <i class="bi bi-question-circle"></i> Transaksi Belanja
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="Admin_lihatPelanggan.php">
                <i class="bi bi-file-text"></i> Customer
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="Admin_lihatBukuTamu.php">
                <i class="bi bi-question-circle"></i> Guest Book
              </a>
            </li>
          </ul>
        </li>
