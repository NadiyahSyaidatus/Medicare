...
<li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
              <a class="dropdown-item" href="produkAdmin.php">
                <i class="bi bi-basket-fill"></i> Daftar Produk
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="viewCustomer.php">
                <i class="bi bi-file-text"></i> Customer
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="viewTransaksi.php">
                <i class="bi bi-question-circle"></i> Transaksi Belanja
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="viewGuestBook.php">
